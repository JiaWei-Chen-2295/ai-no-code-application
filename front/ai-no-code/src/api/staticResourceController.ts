...
export async function previewLatestVersion(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.previewLatestVersionParams,
  options?: { [key: string]: any }
) {
...
/** 此处后端没有提供注释 GET /static/preview/${param0}/${param1}/&#42;&#42; */
export async function previewSpecificVersion(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.previewSpecificVersionParams,
  options?: { [key: string]: any }
) {
  const { appId: param0, version: param1, ...queryParams } = params
  return request<string>(`/static/preview/${param0}/${param1}/**`, {
    method: 'GET',
    params: { ...queryParams },
    ...(options || {}),
  })
